...
class HotcofDetailScreen extends StatefulWidget {
  HotcofDetailScreen({this.kahveID});
  final String? kahveID;
  @override
  State<HotcofDetailScreen> createState() => _HotcofDetailScreenState();
}

class _HotcofDetailScreenState extends State<HotcofDetailScreen> {
  bool loading = false;
