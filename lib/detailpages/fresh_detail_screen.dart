...
class FreshDetailScreen extends StatefulWidget {
  FreshDetailScreen({this.kahveID});
  final String? kahveID;
  @override
  State<FreshDetailScreen> createState() => _FreshDetailScreenState();
}

class _FreshDetailScreenState extends State<FreshDetailScreen> {
  bool loading = false;
