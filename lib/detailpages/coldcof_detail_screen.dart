...
class ColdcofDetailScreen extends StatefulWidget {
  ColdcofDetailScreen({this.kahveID});
  final String? kahveID;
  @override
  State<ColdcofDetailScreen> createState() => _ColdcofDetailScreenState();
}

class _ColdcofDetailScreenState extends State<ColdcofDetailScreen> {
  bool loading = false;
