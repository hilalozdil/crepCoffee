...
import 'package:flutter_application_1/detailpages/cake_detail_screen.dart';
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              log("================= 3");
              return listPastakekler(snapshot);
            } else {
              log("================= 4");
