...
import 'package:flutter_application_1/detailpages/bread_detail_screen.dart';
        ...
        builder: (context, snapshot) {
          if (snapshot.hasError) {
            ...
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              log("================= 3");
              return listKahvaltiliklar(snapshot);
            } else {
              log("================= 4");
            ...
            child: GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => BreadDetailScreen(
                      kahveID: e.id,
                    ),
                  ),
                );
